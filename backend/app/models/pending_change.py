...
class PendingProductChange(Base, TimestampMixin):
    ...
    delivery_attempt_id: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
    ...
    safe_confirmation_summary: Mapped[dict | None] = mapped_column(JSON, nullable=True)
